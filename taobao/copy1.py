...
if __name__ == '__main__':
    # proxy_ip = get_proxy()
    # word = random.choice(get_key_words_in_file())
    # word1 = random.choice(get_key_words_in_file())
    # try:
    #     threading.Thread(target=entry, args=(word,)).start()
    #     threading.Thread(target=entry, args=(word1,)).start()
    # except Exception as e:
    #     print(e)
    while True:
        # for word in get_key_words_in_file():
        word = random.choice(get_key_words_in_file())
        print("#" * 100)
